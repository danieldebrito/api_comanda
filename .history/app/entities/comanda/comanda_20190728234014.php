...
class comanda
{
    ...
    public function create()
    {
		...
		");
            ...
            $consulta->bindValue(':id_empleado_mozo', $this->id_empleado_mozo, PDO::PARAM_INT);
            $consulta->bindValue(':id_estado_comanda', $this->id_estado_comanda, PDO::PARAM_INT);
            $consulta->bindValue(':entregado_a_tiempo', $this->entregado_a_tiempo, PDO::PARAM_STR);
            $consulta->bindValue(':fecha_comanda', $this->fecha_comanda, PDO::PARAM_INT);
